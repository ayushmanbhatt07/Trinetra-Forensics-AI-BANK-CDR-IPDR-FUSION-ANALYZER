...
function Cursor({ className, ...props }: CursorProps) {
  return (
    <CursorPrimitive className={cn('size-6 text-foreground', className)} {...props}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" className="size-full">
        <path
          fill="currentColor"
...
function CursorFollow({
  ...
  return (
    <CursorFollowPrimitive sideOffset={sideOffset} alignOffset={alignOffset} {...props} className={cn(
